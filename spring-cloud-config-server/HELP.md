...
* The original package name 'com.microservices.v2.spring-cloud-config-server' is invalid and this project uses 'com.microservices.v2.springcloudconfigserver' instead.
